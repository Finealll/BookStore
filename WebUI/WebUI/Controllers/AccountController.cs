...
using WebUI.Models.Accounting; // пространство имен моделей RegisterModel и LoginModel
using BookStore.Entities.Accounting; // пространство имен UserContext и класса User
